...
function formatAbi(abi) {
  ...
  for (let i = 0; i < length; i++) {
    const abiItem = abi[i];
    const signature = formatAbiItem2(abiItem);
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-6IKSU4FV.js");
...
//# sourceMappingURL=chunk-P6MIN3UT.js.map
