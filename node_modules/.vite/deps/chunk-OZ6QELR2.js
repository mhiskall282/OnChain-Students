...
// node_modules/@thirdweb-dev/sdk/dist/QueryParams-32a56510.browser.esm.js
init_lib();
...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  let uri;
  const ERC165MetadataAbi = (await import("./IERC165-ZNTC57AS.js")).default;
  ...
  if (isERC721) {
    const ERC721MetadataAbi = (await import("./IERC721Metadata-YGPXKK4B.js")).default;
    const erc721 = new Contract(contractAddress, ERC721MetadataAbi, provider);
    uri = await erc721.tokenURI(tokenId);
  } else if (isERC1155) {
    const ERC1155MetadataAbi = (await import("./IERC1155Metadata-TKWMJJDX.js")).default;
...
//# sourceMappingURL=chunk-OZ6QELR2.js.map
