...
var c147 = {
  ...
  "networkId": 147,
  "rpc": ["https://147.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://mainnet-rpc.flagscan.xyz"],
  "shortName": "FLAG",
  "slug": "flag",
  "testnet": false
};
...
var c1147 = {
  ...
  "networkId": 1147,
  "rpc": ["https://1147.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://testnet-rpc.flagscan.xyz"],
  "shortName": "tFLAG",
  "slug": "flag-testnet",
  "testnet": true
};
...
var c62320 = {
  ...
  "networkId": 62320,
  "rpc": ["https://62320.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://baklava-forno.celo-testnet.org"],
  "shortName": "BKLV",
  "slip44": 1,
...
function getValidChainRPCs(chain, clientId) {
  ...
  chain.rpc.forEach((rpc) => {
    ...
    if (rpc.includes("${THIRDWEB_API_KEY}")) {
      if (clientId) {
        processedRPCs.push(rpc.replace("${THIRDWEB_API_KEY}", clientId) + (typeof globalThis !== "undefined" && "APP_BUNDLE_ID" in globalThis && !!globalThis.APP_BUNDLE_ID ? (
          // @ts-ignore
...
var defaultChains = [c1, c11155111, c8453, c84532, c137, c80001, c42161, c421614, c10, c11155420, c56, c97, c250, c4002, c43114, c43113, c1337];
...
//# sourceMappingURL=chunk-Q3CBO36D.js.map
