import {
  walletConnectV1
} from "./chunk-EPNW7L7O.js";
import {
  magicLink
} from "./chunk-SQIRSBPJ.js";
import {
  safeWallet
} from "./chunk-3PLGY47S.js";
import {
  frameWallet
} from "./chunk-G47HBOX3.js";
import {
  bloctoWallet
} from "./chunk-QTDIGQWK.js";
import {
  ConnectEmbed,
  ConnectModalInline,
  ConnectWallet,
  ...
  useWalletConnect,
  useWalletConnectV1
} from "./chunk-TBBXMUMH.js";
import "./chunk-O7KLDJOJ.js";
import {
  ConnectingScreen,
...
import "./chunk-7TEPPF6D.js";
import "./chunk-BGCQ64CW.js";
import "./chunk-SQHU4NWU.js";
import "./chunk-HGG7E5XN.js";
import {
...
import "./chunk-DJXLT4TK.js";
import "./chunk-JBE6NEQY.js";
import "./chunk-R3IZTCGT.js";
import "./chunk-HVX2K7ZM.js";
import "./chunk-OTUMHCRH.js";
import "./chunk-MOOHJFQZ.js";
import {
...
import {
  VoteType
} from "./chunk-XZJ3BFHI.js";
import {
  extractConstructorParams,
  extractFunctions
} from "./chunk-4VRDPEGN.js";
import {
  Account,
  AccountFactory,
  AdminFlag,
  ...
  getDeploymentInfo
} from "./chunk-FDLGODTI.js";
import {
  fetchSourceFilesFromMetadata
} from "./chunk-RFADWPZZ.js";
...
import {
  ...
  PackRewardsSchema
} from "./chunk-C5DY5UV7.js";
import {
  Erc20,
  Erc20SignatureMintable,
  normalizeAmount
} from "./chunk-J2J3BHBF.js";
import {
  ListingType
...
import {
  ...
  MarketplaceV3Offers,
  Status
} from "./chunk-N47MKLJY.js";
import {
  cleanCurrencyAddress
} from "./chunk-GEABY5TB.js";
import {
  hasERC20Allowance
} from "./chunk-4VOULAWJ.js";
import "./chunk-JYWTYOAO.js";
import {
  Erc721,
  Erc721WithQuantitySignatureMintable,
  toWei
} from "./chunk-FS3MIAKL.js";
import {
  DropClaimConditions
} from "./chunk-FEKJYRXO.js";
...
} from "./chunk-7MQZ4RHF.js";
import {
  ContractPrimarySale
} from "./chunk-4P3MW4B3.js";
import {
  ContractPlatformFee
} from "./chunk-NJRVAO2S.js";
import {
  ContractInterceptor
...
import {
  ...
  StartDateSchema,
  assertEnabled
} from "./chunk-FI66JFUW.js";
import {
  InterfaceId_IERC1155,
  InterfaceId_IERC721
} from "./chunk-OZ6QELR2.js";
import {
  normalizePriceValue,
  setErc20Allowance
} from "./chunk-FOX4ZHAY.js";
import {
  ContractRoles
} from "./chunk-KMYQOINL.js";
import {
  ContractAppURI,
  ContractEncoder,
  ContractEvents,
...
import "./chunk-4L724BZI.js";
import {
  require_jsx_runtime
} from "./chunk-NGTPNYLZ.js";
import "./chunk-OW7WLWPA.js";
import {
  require_react
...
// node_modules/@thirdweb-dev/react/dist/useSafe-dc4b7f62.browser.esm.js
...
function useSafe() {
  ...
  return (0, import_react.useCallback)(async (connectProps) => {
    ...
    } = await import("./safeWallet-c3871ee1.browser.esm-U22OCLQL.js");
    return connect(safeWallet2(), connectProps);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useMagic-a23dfa07.browser.esm.js
...
function useMagic() {
  ...
  return (0, import_react2.useCallback)(async (options) => {
    ...
    } = await import("./magicLink-7eff08c8.browser.esm-ZKUUILJO.js");
...
var openCenteredPopup = (_ref) => {
  ...
  if (!(window == null ? void 0 : window.top)) {
    return null;
  }
  ...
  return (event) => {
    ...
    switch (data.eventType) {
      ...
      case "sizing":
        ...
        break;
      case "onPriceUpdate": {
        onPriceUpdate == null ? void 0 : onPriceUpdate(data);
        break;
      }
    }
  };
...
function useSmartWallet(personalWallet, options) {
  ...
  const predictAddress = (0, import_react3.useCallback)(async (args) => {
    return getSmartWalletAddress(context.activeChain, options.factoryAddress || DEFAULT_FACTORY_ADDRESS, args.personalWalletAddress, args.data);
  ...
  const connect = (0, import_react3.useCallback)(async (args) => {
    ...
    try {
      if (args == null ? void 0 : args.connectPersonalWallet) {
      ...
      await sw.connect({
        ...args == null ? void 0 : args.connectionArgs,
        personalWallet: pw
      });
      setStatus("connected");
      setWallet(sw);
...
function openCenteredPopup2(_ref) {
  ...
  const height = ((_a = win == null ? void 0 : win.top) == null ? void 0 : _a.outerHeight) || 100;
  const width = ((_b = win == null ? void 0 : win.top) == null ? void 0 : _b.outerWidth) || 100;
  const screenX = ((_c = win == null ? void 0 : win.top) == null ? void 0 : _c.screenX) || 100;
  const screenY = ((_d = win == null ? void 0 : win.top) == null ? void 0 : _d.screenY) || 100;
...
var VerifyOwnershipWithPaper = (_ref) => {
  ...
  const onClick = () => {
    ...
    loginWindow == null ? void 0 : loginWindow.focus();
  };
