...
} from "./chunk-NUWOKTHW.js";
import {
  IERC721_default
} from "./chunk-N735XVS2.js";
import {
  IERC721Metadata_default
} from "./chunk-NDDS3XQE.js";
import {
  IERC1155_default
} from "./chunk-I2GNSU5T.js";
import {
  IERC1155Metadata_default
} from "./chunk-LRN3HBSZ.js";
import {
  IERC20_default
} from "./chunk-DUR6YZYN.js";
import {
  __commonJS,
  __publicField,
  __toCommonJS,
...
async function dangerouslyDeriveParameters(password, salt, keySizeDWORD, ivSizeDWORD, iterations) {
  ...
  const key = await crypto3.subtle.importKey("raw", rawKey, "AES-CBC", false, ["decrypt"]);
  return {
    key,
    iv
  };
...
async function aesDecrypt(ciphertext, password) {
  ...
  const pwHash = await crypto3.subtle.digest("SHA-256", pwUtf8);
  ...
  const key = await crypto3.subtle.importKey("raw", pwHash, alg, false, ["decrypt"]);
  const ctUint8 = cipherUint8Array.slice(12);
  try {
    const plainBuffer = await crypto3.subtle.decrypt(alg, key, ctUint8);
    return getCachedTextDecoder().decode(plainBuffer);
  } catch (e) {
    throw new Error("Decrypt failed");
  }
...
async function aesEncrypt(plaintext, password) {
  ...
  const pwHash = await crypto3.subtle.digest("SHA-256", pwUtf8);
  const iv = crypto3.getRandomValues(new Uint8Array(12));
  const alg = {
    name: "AES-GCM",
    iv
  };
  const key = await crypto3.subtle.importKey("raw", pwHash, alg, false, ["encrypt"]);
  const ptUint8 = textEncoder.encode(plaintext);
  const ctBuffer = await crypto3.subtle.encrypt(alg, key, ptUint8);
...
// node_modules/@thirdweb-dev/sdk/dist/index-33cd3415.browser.esm.js
init_lib();
...
var ModularFactoryInput = (() => z.object({
...
var RouterTypeInput = (() => z.union([z.literal("none"), z.literal("plugin"), z.literal("dynamic"), z.literal("modular")]))();
    ...
    switch (compilerOptions.compilerType) {
      case "solc": {
        if (compilerOptions.compilerVersion) {
          metadata = (_a = rawMeta.compilers.solc) == null ? void 0 : _a.find((m) => m.compilerVersion === compilerOptions.compilerVersion && m.evmVersion === compilerOptions.evmVersion);
      ...
      case "zksolc": {
        if (compilerOptions.compilerVersion) {
          metadata = (_b = rawMeta.compilers.zksolc) == null ? void 0 : _b.find((m) => m.compilerVersion === compilerOptions.compilerVersion && m.evmVersion === compilerOptions.evmVersion);
...
async function fetchPublishedContractFromPolygon(publisherAddress, contractName) {
  ...
  const ContractPublisherAbi = (await import("./ContractPublisher-UGOIXVPZ.js")).default;
...
async function getPrebuiltInfo(address, provider2) {
  try {
    const IThirdwebContractABI = (await import("./IThirdwebContract-K4JVVRZX.js")).default;
...
async function getMetadataUriFromMultichainRegistry(address, chainId, sdkOptions) {
  var _a;
  const TWRegistryABI = (await import("./TWMultichainRegistryLogic-YIMHUYKM.js")).default;
...
async function computeCreate2FactoryTransaction(provider2) {
  ...
  if (CUSTOM_GAS_FOR_CHAIN[networkId]) {
    ...
    const gasPrice = (_a = CUSTOM_GAS_FOR_CHAIN[networkId]) == null ? void 0 : _a.gasPrice;
    const gasLimit = (_b = CUSTOM_GAS_FOR_CHAIN[networkId]) == null ? void 0 : _b.gasLimit;
...
async function signTypedDataInternal(signerInput, domain, types, message) {
  ...
  if ((_a = provider2 == null ? void 0 : provider2.provider) == null ? void 0 : _a.isWalletConnect) {
    try {
      signature = await provider2.send("eth_signTypedData_v4", [signerAddress, JSON.stringify(payload)]);
    } catch (err) {
    ...
    try {
      ...
      if ((_c = err == null ? void 0 : err.message) == null ? void 0 : _c.includes("eth_signTypedData_v4")) {
        signature = await provider2.send("eth_signTypedData", [signerAddress, JSON.stringify(payload)]);
      } else {
        try {
...
Expected function signature: ${functions[0].signature}`);
  ...
  async enginePrepareRequest(transaction) {
    ...
    if (transaction.functionName === "approve" && transaction.functionArgs.length === 2) {
      ...
      const ForwarderABI = (await import("./Forwarder-I2P6B2F3.js")).default;
...
async function getCompositeABI(address, abi, provider2, options, storage) {
  ...
  try {
    ...
    if (isbaseRouter) {
      ...
      const contract = new ContractWrapper(provider2, address, coreContractAbi, options, storage);
      ...
      pluginABIs = await getPluginABI(extensionAddresses, provider2, storage);
...
var EditionDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(address, provider2, storage), import("./edition-drop-294e1578.browser.esm-SCOVZFFH.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC1155-HVRADJEC.js")).default : (await import("./DropERC1155_V2-I3XSAHH2.js")).default;
  }
};
var EditionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider2, storage), import("./edition-1ccecf2c.browser.esm-UXPPTYB4.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC1155-HQD2YWKV.js")).default;
  }
};
var MarketplaceInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider2, storage), import("./marketplace-2e2adc0e.browser.esm-U46XGKGN.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Marketplace-RSDRQ7N2.js")).default;
  }
};
var MarketplaceV3Initializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider2, storage, options), import("./marketplacev3-ef469d89.browser.esm-BBNOUFQX.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage, options) => {
    ...
    const localAbi = (await import("./MarketplaceV3-YCH36GCO.js")).default;
...
var MultiwrapInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider2, storage), import("./multiwrap-2e713f6c.browser.esm-L2XU4DNA.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Multiwrap-46RJIDAY.js")).default;
  }
};
var NFTCollectionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider2, storage), import("./nft-collection-5b9d9850.browser.esm-KUH32GDS.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC721-ZBOIO3C5.js")).default;
  }
};
var NFTDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider2, storage), import("./nft-drop-ee9ded99.browser.esm-GKR4PWKN.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 3 ? (await import("./DropERC721-M2ITQI5E.js")).default : (await import("./DropERC721_V3-CBO3365Z.js")).default;
  }
};
var PackInitializer = {
  name: "Pack",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider2, storage), import("./pack-02f90278.browser.esm-XEUU4YXT.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return AbiSchema.parse((await import("./Pack-2PFGQEFK.js")).default || []);
  }
};
var SignatureDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider2, storage), import("./signature-drop-266c8004.browser.esm-O6JM76DE.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 4 ? (await import("./SignatureDrop-MZEVI37C.js")).default : (await import("./SignatureDrop_V4-BV24TLZM.js")).default;
  }
};
var SplitInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider2, storage), import("./split-eb66a32f.browser.esm-5NSJQWLI.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Split-SWZTEG3B.js")).default;
  }
};
var TokenDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider2, storage), import("./token-drop-889631f7.browser.esm-FRQOLQOM.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC20-JIOJW6NG.js")).default : (await import("./DropERC20_V2-HXZDDHRP.js")).default;
  }
};
var TokenInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider2, storage), import("./token-1e82c71a.browser.esm-FAFIMFXZ.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC20-LNELUKYD.js")).default;
  }
};
var VoteInitializer = {
  name: "VoteERC20",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider2, storage), import("./vote-e5646e80.browser.esm-ZGPDYEFE.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./VoteERC20-CHUSTTT4.js")).default;
  }
};
...
// node_modules/@thirdweb-dev/sdk/dist/transactions-72f9603c.browser.esm.js
init_lib();
...
async function getDynamicFeeData(provider2) {
  ...
  if (chainId === c147.chainId || chainId === c1147.chainId) {
    return {
      maxFeePerGas: null,
...
function isOpStackChain(chainId) {
  return chainId === c10.chainId || chainId === c11155420.chainId || chainId === c8453.chainId || chainId === c84532.chainId || chainId === c7777777.chainId || chainId === c999999999.chainId || chainId === c42220.chainId || chainId === c44787.chainId || chainId === 204 || // opBNB
  chainId === 5611;
}
...
@thirdweb-dev/crypto/dist/thirdweb-dev-crypto.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QRVYLIJU.js.map
