...
// node_modules/@thirdweb-dev/sdk/dist/erc-1155-7ce9bee1.browser.esm.js
init_lib();
...
var DropErc1155ClaimConditions = class {
  constructor(contractWrapper, metadata, storage) {
     ...
     */
    __publicField(this, "set", buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this = this;
     ...
     * @param resetClaimEligibilityForAll - Whether to reset the state of who already claimed NFTs previously
     */
    __publicField(this, "setBatch", buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this2 = this;
  ...
  async getClaimIneligibilityReasons(tokenId, quantity, addressToCheck) {
    ...
    if (claimCondition.price.gt(0) && isNode()) {
      ...
      if (isNativeToken(claimCondition.currencyAddress)) {
        ...
        const IERC20ABI = (await import("./IERC20-NUER4BV7.js")).default;
...
var Erc1155 = class {
  constructor(contractWrapper, storage, chainId) {
     ...
     * @twfeature ERC1155
     */
    __publicField(this, "transfer", buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this = this;
     ...
     */
    __publicField(this, "transferBatch", buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this2 = this;
     ...
     * @twfeature ERC1155
     */
    __publicField(this, "transferFrom", buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this3 = this;
     ...
     * @twfeature ERC1155BatchTransferable
     */
    __publicField(this, "airdrop", buildTransactionFunction(/* @__PURE__ */ (() => {
      var _this4 = this;
...
//# sourceMappingURL=chunk-7MQZ4RHF.js.map
