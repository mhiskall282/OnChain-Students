...
var storage = isStorageSupported() ? window.sessionStorage : memoryStorage;
...
var setEvmAddress = (key, chain, accounts) => {
  setAccountStorage(key, { evm: { [chain]: accounts } });
  return;
};
var removeAllEvmAddress = (key) => {
...
var isValidTransactions = (transactions) => {
...
var _EthereumProvider_createAuthzFrame;
...
@blocto/sdk/dist/blocto-sdk.module.js:
   ...
   *)
*/
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-JZ25U3K2.js.map
