...
var wt = (n, e) => {
  for (var t in e) Y(n, t, { get: e[t], enumerable: true });
};
var At = (n, e, t, r2) => {
  if (e && typeof e == "object" || typeof e == "function") for (let o2 of bt(e)) !_e.call(n, o2) && o2 !== t && Y(n, o2, { get: () => e[o2], enumerable: !(r2 = Pt(e, o2)) || r2.enumerable });
  return n;
};
...
var E = class {
  ...
  comparePre(e) {
    ...
    do {
      ...
      if (m2("prerelease compare", t, r2, o2), r2 === void 0 && o2 === void 0) return 0;
      if (o2 === void 0) return 1;
      if (r2 === void 0) return -1;
      if (r2 !== o2) return K(r2, o2);
    } while (++t);
  }
  compareBuild(e) {
...
var L = class {
  ...
  test(e) {
    if (m2("Comparator.test", e, this.options.loose), this.semver === j || e === j) return true;
  ...
  intersects(e, t) {
    ...
    if (t && typeof t == "object" || (t = { loose: !!t, includePrerelease: false }), this.operator === "") return this.value === "" || new $(e.value, t).test(this.value);
...
var $ = class {
  constructor(e, t) {
    if (t && typeof t == "object" || (t = { loose: !!t, includePrerelease: false }), e instanceof $) return e.loose === !!t.loose && e.includePrerelease === !!t.includePrerelease ? e : new $(e.raw, t);
...
var un = (n, e, t) => {
  ...
  if (e.prerelease.length && !t.includePrerelease) {
    for (let r2 = 0; r2 < n.length; r2++) if (m2(n[r2].semver), n[r2].semver !== L.ANY && n[r2].semver.prerelease.length > 0) {
      let o2 = n[r2].semver;
...
var { re: je, t: We } = W;
var mn = (n, e) => {
  if (e && typeof e == "object" || (e = { loose: !!e, includePrerelease: false }), n instanceof E) return n;
...
var He = (n, e) => {
  ...
  if ((e = e || {}).rtl) {
    let r2;
    for (; (r2 = ee[te.COERCERTL].exec(n)) && (!t || t.index + t[0].length !== n.length); ) t && r2.index + r2[0].length === t.index + t[0].length || (t = r2), ee[te.COERCERTL].lastIndex = r2.index + r2[1].length + r2[2].length;
...
var I = class {
  ...
  request(e) {
    let t = this.overlay.post(o.MAGIC_HANDLE_REQUEST, _(e)), r2 = ce((s, a2) => {
      t.then((i) => {
        if (o2(), i.hasError) a2(new M(i.payload.error));
...
var ye = class extends I {
  ...
  sendAsync(t, r2) {
    if (!r2) throw rt({ procedure: "Magic.rpcProvider.sendAsync", argument: 1, expected: "function", received: r2 === null ? "null" : typeof r2 });
...
var tt2 = (b2, A, R, L2) => {
  if (A && typeof A == "object" || typeof A == "function") for (let D3 of kr(A)) !rt2.call(b2, D3) && D3 !== R && Je2(b2, D3, { get: () => A[D3], enumerable: !(L2 = qr(A, D3)) || L2.enumerable });
  return b2;
};
...
var ke2 = $e2((qe2, Ne2) => {
  (function(b2) {
    ...
    return function L2(D3, X2, P) {
      ...
      for (var I2 = typeof ve == "function" && ve, M3 = 0; M3 < P.length; M3++) Y3(P[M3]);
      return Y3;
    }({ 1: [function(L2, D3, X2) {
      (function(P) {
        "use strict";
      ...
      m3.prototype.catch = function(h2) {
        ...
        if (typeof h2 != "function" && this.state === H3 || typeof N3 != "function" && this.state === M3) return this;
        var E3 = new this.constructor(Y3);
        if (this.state !== $3) {
          var O2 = this.state === H3 ? h2 : N3;
          B(E3, O2, this.outcome);
        } else this.queue.push(new _2(E3, h2, N3));
        return E3;
      };
      ...
      I2.resolve = function(h2, N3) {
        ...
        if (O2) Z2(h2, O2);
          ...
          for (var V2 = -1, j3 = h2.queue.length; ++V2 < j3; ) h2.queue[V2].callFulfilled(N3);
        }
        return h2;
      }, I2.reject = function(h2, N3) {
        h2.state = M3, h2.outcome = N3;
        for (var E3 = -1, O2 = h2.queue.length; ++E3 < O2; ) h2.queue[E3].callRejected(N3);
        return h2;
      };
      function z3(h2) {
        var N3 = h2 && h2.then;
        if (h2 && (typeof h2 == "object" || typeof h2 == "function") && typeof N3 == "function") return function() {
      ...
      function ae3(h2) {
        ...
        for (var V2 = new Array(E3), j3 = 0, Q2 = -1, J3 = new this(Y3); ++Q2 < E3; ) ee2(h2[Q2], Q2);
        return J3;
        function ee2(oe2, a2) {
      ...
      function re2(h2) {
        ...
        var E3 = h2.length, O2 = false;
        if (!E3) return this.resolve([]);
        for (var V2 = -1, j3 = new this(Y3); ++V2 < E3; ) Q2(h2[V2]);
        return j3;
        function Q2(J3) {
      ...
      function T3(e, t, r2, o2) {
        ...
        try {
          ...
          if (o2 > 0 && (!e.db || n.name === "InvalidStateError" || n.name === "NotFoundError")) return m3.resolve().then(function() {
      ...
      function Ke2(e) {
        ...
        for (o2 = 0; o2 < r2; o2 += 4) n = te3.indexOf(e[o2]), f = te3.indexOf(e[o2 + 1]), u2 = te3.indexOf(e[o2 + 2]), c2 = te3.indexOf(e[o2 + 3]), d2[i++] = n << 2 | f >> 4, d2[i++] = (f & 15) << 4 | u2 >> 2, d2[i++] = (u2 & 3) << 6 | c2 & 63;
        return l;
      }
      function Ee2(e) {
        var t = new Uint8Array(e), r2 = "", o2;
        for (o2 = 0; o2 < t.length; o2 += 3) r2 += te3[t[o2] >> 2], r2 += te3[(t[o2] & 3) << 4 | t[o2 + 1] >> 4], r2 += te3[(t[o2 + 1] & 15) << 2 | t[o2 + 2] >> 6], r2 += te3[t[o2 + 2] & 63];
      ...
      var jr = function() {
        function e(t) {
          Y3(this, e);
          for (var r2 in ue3) if (ue3.hasOwnProperty(r2)) {
    ...
    function O2(a2, s) {
      var v = this, p2 = this.ready().then(function() {
        for (var g2 = v._dbInfo.mStore, w2 = g2.keys(), T3 = 0; T3 < w2.length; T3++) {
          var G2 = g2.get(w2[T3]);
          if (G2 && (G2 = v._dbInfo.serializer.deserialize(G2)), G2 = a2(G2, w2[T3], T3 + 1), G2 !== void 0) return G2;
        }
      });
      return B(p2, s), p2;
    }
...
function ft2(b2) {
  for (let [A, R] of Object.entries(at2)) b2.style[A] = R;
}
function ut2(b2) {
...
var pe2 = class extends Se {
  ...
  init() {
    this.test = "hello", this.iframe = new Promise((R) => {
      let L2 = () => {
        if (ut2(encodeURIComponent(this.parameters))) mr().log();
        else {
      ...
      if (R.origin === this.endpoint && R.data && R.data.msgType && this.messageHandlers.size) {
        ...
        for (let D3 of this.messageHandlers.values()) D3(R);
      }
    });
  }
  showOverlay() {
...
var se3 = (n, r2, s, m3) => {
  if (r2 && typeof r2 == "object" || typeof r2 == "function") for (let h2 of ie(r2)) !oe.call(n, h2) && h2 !== s && D2(n, h2, { get: () => r2[h2], enumerable: !(m3 = ne2(r2, h2)) || m3.enumerable });
  return n;
};
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-magic.browser.esm-4EMRARUX.js.map
